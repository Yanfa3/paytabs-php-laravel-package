...
namespace Yanfaa\Laravel_paytabs\Services;
...
class IpnRequest
{
    ...
    private function isValidIPNRequest($httpRequest){
        ...
        new \Yanfaa\Laravel_paytabs\paytabs_core(); //this is a hack just to be able to use `PaytabsApi` class from paytabs_core.php !!!

        $paytabs_api= \Yanfaa\Laravel_paytabs\PaytabsApi::getInstance(config('paytabs.region'), config('paytabs.profile_id'), config('paytabs.server_key'));
